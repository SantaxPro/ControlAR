    ...
    <View style={styles.mainContainer}>
        <View style={styles.container}>
          ...
          <View style={styles.horizontal}>
            ...
            />
            <Text style={styles.title}>{props.route.params.user.nickname}</Text>
          </View>

          <View style={styles.horizontal}>
            <Text style={styles.subtitle}>{props.route.params.user.name}</Text>
          </View>

          <View style={styles.horizontal}>
            <MaterialIcons name="verified" size={24} color={theme.colors.blue} />
            <Text style={[styles.subtitle, {color: "hsla(0, 0%, 22%, 0.90)",}]}>Verificado</Text>
          </View>
